...
namespace Gameplay._Data
{
	...
	public class UZIData : GunData
	{
		...
		[field: SerializeField]
		public override int ShotsPerMagazine { get; }

		[field: SerializeField]
		public override int BulletsPerShot { get; }

		[field: SerializeField]
		public override float ShotAngleRandomness { get; }

		[field: SerializeField]
		public override float StartingDelay { get; }

		[field: SerializeField]
		public override float DelayBetweenShots { get; }
