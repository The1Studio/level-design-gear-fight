...
{
	[Serializable]
	public class ForestGolemData : TroopData
	{
		...
		[field: SerializeField]
		public int MinRockAttack { get; }

		[field: SerializeField]
		public int MaxRockAttack { get; }

		[field: SerializeField]
		public float AttackDelayAfterFirstAttack { get; }

		[field: SerializeField]
		public float AttackDelayStart { get; }
