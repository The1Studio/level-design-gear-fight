...
[Serializable]
public class SamuraiData : TroopData
{
	...
	[field: SerializeField]
	public float DashTimer { get; }

	[field: SerializeField]
	public float DashAttackCooldown { get; }

	[field: SerializeField]
	public float DashAttackDistance { get; }

	[field: SerializeField]
	public float DashKnockback { get; }
}
