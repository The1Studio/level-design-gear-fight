...
{
	[Serializable]
	public class MossQueenData : TroopData
	{
		...
		[field: SerializeField]
		public float TroopSpawnHealthMultiplier { get; }

		[field: SerializeField]
		public float TroopSpawnDamageMultiplier { get; }

		[field: SerializeField]
		public float TroopSpawnCooldown { get; }
